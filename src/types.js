export const BLOCK_TYPES = [
  ...
  { label: 'S', style: 'small' },
  { label: 'CTA', icon: 'call_to_action', style: 'call-to-action' },
  { label: 'Note', icon: 'note', style: 'note' },
...
export const ATOMIC_TYPES = [
  { label: 'Image', icon: 'add_a_photo', style: 'image' },
  { label: 'Table', icon: 'grid_on', style: 'table' },
  { label: 'Html', icon: 'code', style: 'html' },
  { label: 'Link', icon: 'link', style: 'link' },
]
