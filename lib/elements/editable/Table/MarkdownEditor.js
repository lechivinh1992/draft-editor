...
var MarkdownEditor = function (_Component) {
  ...
  function MarkdownEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MarkdownEditor)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onChange = function (e) {
  ...
  _createClass(MarkdownEditor, [{
    ...
    value: function render() {
      return _react2.default.createElement("input", { type: "text", value: this.props.value, onChange: this.handleChange });
    }
  }]);
...
MarkdownEditor.propTypes = {
  ...
  column: _react.PropTypes.shape({
    ...
    onCellChange: _react.PropTypes.func
  }),
